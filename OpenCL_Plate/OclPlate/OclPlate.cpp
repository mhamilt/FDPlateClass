...
void OclPlate::clupdate(float* out, int frames)
{
    ...
    unsigned int clItems = nextSquare(ss);
    ...
    ^{
        ...
        size_t wgs;
        gcl_get_kernel_block_workgroup_info(fd_plate_kernel, CL_KERNEL_PREFERRED_WORK_GROUP_SIZE_MULTIPLE, sizeof(wgs), &wgs, NULL);
        cl_ndrange range =  // 6
        {
